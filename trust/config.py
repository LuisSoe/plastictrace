...
LOCK_MIN_CONF = 0.70  # Minimum EMA confidence to lock
LOCK_MIN_MARGIN = 0.15  # Minimum margin (p1 - p2) to lock
LOCK_MIN_VOTE_RATIO = 0.75  # Minimum vote ratio to lock (e.g., 15/20 agree)
